...
export const matches = createTable(
  "match",
  {
    ...
    round1Home: integer("round1Home").notNull(),
    round1Away: integer("round1Away").notNull(),
    round2Home: integer("round2Home").notNull(),
    round2Away: integer("round2Away").notNull(),
    round3Home: integer("round3Home").notNull(),
    round3Away: integer("round3Away").notNull(),
...
//       .notNull()
//       .references(() => users.id),
//     team: varchar("team", { length: 4 }).notNull(), // 'home' or 'away'
//   },
//   (matchParticipant) => ({
//     matchPlayerIdx: index("match_player_idx").on(
//       matchParticipant.matchId,
//       matchParticipant.playerId,
//     ),
//     uniqueParticipant: index("unique_participant_idx").on(
//       matchParticipant.matchId,
