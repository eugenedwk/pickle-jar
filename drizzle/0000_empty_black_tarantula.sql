...
CREATE TABLE IF NOT EXISTS "picklejar_match" (
	...
	"round1Home" integer NOT NULL,
	"round1Away" integer NOT NULL,
	"round2Home" integer NOT NULL,
	"round2Away" integer NOT NULL,
	"round3Home" integer NOT NULL,
	"round3Away" integer NOT NULL,
